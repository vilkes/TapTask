...
class Servicio {
    ...
    private $conexion;
     ...
     public function __construct($titulo = null, $descripcion = null, $etiquetas = null, $ubicacion = null, $precio = null, $disponibilidad = null, $tipoServicio = null,$duracion=null) {
        global $pdo;
        $this->conexion = $pdo;
        if ($titulo !== null) {
            $this->titulo = $titulo;
     ...
     public function agregarServicio($usuarioId) {
        $sql = "INSERT INTO servicio (iduser_servicio, titulo, descripcion, etiquetas, ubicacion, precio, disponibilidad, tipoServicio,duracion) 
                VALUES (:iduser_servicio, :titulo, :descripcion, :etiquetas, :ubicacion, :precio, :disponibilidad,:tipoServicio,:duracion)";
        $stmt = $this->conexion->prepare($sql);
        $stmt->execute([
        ':iduser_servicio' => $usuarioId,
        ':titulo' => $this->titulo,
