    ...
    <section id="taptask-ID" class="perfil-contenedor">
      <div class="avatar-section">
        ...
        <?php
          ...
          $rutaImagen = $datos['cliente']['foto_perfil'] ?? null;
          if (!$rutaImagen) {
              $rutaImagen = '../imagenesGNRL/defaultprofilepic.png';
          }
?>
          <img src="<?php echo $rutaImagen ?>" alt="Avatar" />
        </div>
        ...
        <form>
          <div class="form-row">
            <div class="form-group">
              ...
              <input name="nombreUsuario" type="text" placeholder="" value="<?php echo $datos['usuario']['nombreUsuario'] ?>"/>
            </div>
            <div class="form-group">
              <label>Email</label>
              <input name="email" type="email" placeholder="" value="<?php echo $datos['cliente']['email'] ?>"/>
            </div>
          </div>
      ...
      <div class="form-section">
        ...
        <form>
          <div class="form-row">
            <div class="form-group">
              <label>Nombre</label>
              <input name="nombre" type="text" placeholder="" value="<?php echo $datos['cliente']['nombre'] ?>"/>
            </div>
            <div class="form-group">
              <label>Apellido</label>
              <input name="apellido" type="text" placeholder="" value="<?php echo $datos['cliente']['apellido'] ?>"/>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group">
              <label>Fecha de nacimiento</label>
              <input name="fechaNacimiento" type="date" value="<?php echo $datos['cliente']['fechanacimiento'] ?>"/>
            </div>
            <div class="form-group">
              <label>Teléfono</label>
              <input name="telefono" type="text" placeholder=""  value="<?php echo $datos['telefono']['telefonos'] ?>"/>
            </div>
          </div>
          <div class="form-buttons">
            <button type="submit" class="guardar">Guardar cambios</button>
